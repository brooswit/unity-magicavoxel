...
public class VoxPalette
{
    ...
    // Default constructor with empty palette
    public VoxPalette()
    {
    ...
    // Constructor from Color32 array
    public VoxPalette(Color32[] colors)
    {
        if (colors == null)
        {
            this.colors = new Color32[256];
            LoadDefaultPalette();
        }
        else
        {
            this.colors = new Color32[colors.Length];
            System.Array.Copy(colors, this.colors, colors.Length);
        }
    }
    
    // Copy constructor
    public VoxPalette(VoxPalette other)
    {
        ...
        else
        {
            ...
            System.Array.Copy(other.colors, colors, other.colors.Length);
        }
    }
    
    // Get the underlying Color32 array (for compatibility)
    public Color32[] GetColors()
    {
        return colors;
    }
    
    // Load the default MagicaVoxel palette
    ...
    // Create default palette (static factory method)
    public static VoxPalette CreateDefault()
    {
